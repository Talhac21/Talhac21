...
class Account(Base):
    ...
    last_session_check_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
...
class PerkJob(Base):
    ...
    last_result: Mapped[JobStatus] = mapped_column(Enum(JobStatus), default=JobStatus.idle, nullable=False)
